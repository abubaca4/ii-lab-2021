...
/* Условия-характеристики различных видов спорта.*/
   
     cond(1,"тип оздоровительные").
     cond(2,"тип соревновательные").
     cond(3,"Развитие выносливости").
     cond(4,"Индивидуальное").
     cond(5,"Командное").
     cond(6,"Инвентарь плавательный купальник").
     cond(7,"Инвентарь велосипед").
     cond(8,"Инвентарь спортивная обувь").
     cond(9,"Инвентарь спортивная одежда").
     cond(10,"Инвентарь гимнастический купальник").
     cond(11,"Инвентарь лыжи, палки").
     cond(12,"Инвентарь маты").
     cond(13,"Инвентарь волейбольный мяч").
     cond(14,"Инвентарь клюшка, шайба").
     cond(15,"Инвентарь футбольный мяч").
     cond(16,"Инвентарь рапира, защита").

/* Данные о типах спорта */

     topic("оздоровительные").
     topic("соревновательные").

/* Данные о конкретных видах спорта */

     rule(1,"спорт","оздоровительные",[1]).
     rule(2,"спорт","соревновательные",[2]).
     rule(3,"оздоровительные","Плавание",[3,4,6]).
     rule(4,"оздоровительные","Велосипед",[3,4,7]).
     rule(5,"оздоровительные","Бег",[3,4,8]).
     rule(6,"оздоровительные","Фитнес",[3,5,9]).
     rule(7,"оздоровительные","Гимнастика",[3,5,10]).
     rule(8,"оздоровительные","Лыжи",[3,4,11]).
     rule(9,"соревновательные","Единоборства",[3,4,9,12]).
     rule(10,"соревновательные","Кроссфит",[3,4,9]).
     rule(11,"соревновательные","Волейбол",[3,5,13]).
     rule(12,"соревновательные","Хоккей",[3,5,14]).
     rule(13,"соревновательные","Футбол",[3,5,15]).
     rule(14,"соревновательные","Фехтование",[3,4,16]).
...
/* Выдача подсказки */
     ...
     info:-
           findall(Sport_type,topic(Sport_type),Sport_type_list),
           term_str(slist,Sport_type_list,Sport_type_list_str_repr),
           str_char_list(Sport_type_list_str_repr,[_|Sport_type_list_char_repr]),
           reverse(Sport_type_list_char_repr,[_|Sport_type_list_char_repr_rev]),
           reverse(Sport_type_list_char_repr_rev,Sport_type_list_char_repr_rev1),
           pack(Sport_type_list_char_repr_rev1,Sport_type_list_str_repr1),
           dlg_Note("База знаний содержит информацию о видах спорта : ",Sport_type_list_str_repr1),
           assertz(dummy).
...
/* Начальное правило механизма вывода */
     ...
     go(_,Mygoal):-
           ...
           concat("Вероятнее всего Ваш вид спорта : ",Mygoal,Temp),
           concat(Temp,".",Result),
